...
Run: `cargo test -p archductor-core harness -- --nocapture`
...
Run: `cargo test -p archductor-core session_launch -- --nocapture`
...
Run: `cargo test -p archductor --test cli_sessions -- --nocapture`
