...
**Tech Stack:** Rust, GTK4/libadwaita, existing `archductor-core` settings APIs
...
Run: `cargo test -p archductor-gtk settings_sections_keep_expected_order -- --nocapture`
...
Run: `cargo test -p archductor-gtk prompt_section_uses_editor_style_fields -- --nocapture`
...
Run: `cargo test -p archductor-gtk settings_sections_keep_expected_order prompt_section_uses_editor_style_fields -- --nocapture`
Expected: PASS
